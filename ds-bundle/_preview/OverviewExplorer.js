var __dsPreview = (() => {
  ...
  // .design-sync/previews/OverviewExplorer.tsx
  var OverviewExplorer_exports = {};
  __export(OverviewExplorer_exports, {
    CurrentCallWithPlanAhead: () => CurrentCallWithPlanAhead,
    NothingClearsTheBar: () => NothingClearsTheBar
  });
  init_define_import_meta_env();
  ...
  function CurrentCallWithPlanAhead() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: canvas, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.OverviewExplorer, { overview, planAhead, generatedAt, editorial }) });
  }
  function NothingClearsTheBar() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: canvas, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.OverviewExplorer,
      {
        overview: [],
        planAhead: [],
        generatedAt,
  ...
  return __toCommonJS(OverviewExplorer_exports);
})();
